...
Este projeto foi construído para ir além do currículo tradicional em papel, oferecendo uma experiência imersiva e interativa que demonstra na prática o domínio técnico, a capacidade analítica e o rigor operacional de Marcos Vinícius.
...
## 🚀 Funcionalidades e Módulos da Aplicação

### 1. Cabeçalho Enciclopédico & Barra de Ferramentas
- Título padronizado com badges de status de disponibilidade em tempo real.
- Barra de abas funcionais (Artigo Principal, Discussão/Diferenciais, Código-fonte/GitHub e Histórico).
- Campo de busca interna com filtragem instantânea por tópicos e competências.
- Botão de alternância de fonte e atalho para download/impressão direta do currículo.
...
- Ferramenta interativa onde recrutadores e clientes podem selecionar cenários reais de problemas:
  ...
  - *Rotinas manuais lentas que necessitam de automação com Inteligência Artificial*
...
```text
├── public/
│   ├── eu.JPG                         # Foto oficial de perfil
│   ├── vini-amaral.jpg                # Alias de compatibilidade da foto
│   ├── foto.jpg                       # Alias de compatibilidade da foto
...
│   ├── components/
│   │   ├── Header.tsx                 # Barra superior enciclopédica e busca
...
│   │   ├── DifferentialsWiki.tsx      # Diferenciais competitivos e postura de trabalho
│   │   ├── ExperienceWiki.tsx         # Experiências profissionais detalhadas
│   │   ├── ContactWiki.tsx            # Seção de contato, links e formulário
│   │   ├── FooterWiki.tsx             # Rodapé com créditos e links enciclopédicos
│   │   └── WhatsAppFloatingButton.tsx # Botão flutuante de atendimento WhatsApp
│   ├── data/
│   │   └── portfolioData.ts           # Base de dados estruturada do portfólio
│   ├── types.ts                       # Tipagens e interfaces TypeScript
│   ├── index.css                      # Estilos globais e fontes temáticas
│   ├── main.tsx                       # Ponto de entrada React
│   └── App.tsx                        # Componente raiz da aplicação
├── generate-pdf.js                    # Script Node.js para geração do PDF do currículo
...
1. **Clone o repositório:**
   ```bash
   git clone https://github.com/viniamaral2026-cpu/portfolio-vini-amaral.git
   cd portfolio-vini-amaral
   ```
...
4. **Para gerar uma nova versão do PDF do currículo:**
   ```bash
...
6. **Para checar tipos com TypeScript:**
   ```bash
   npm run lint
   ```
...
- **LinkedIn:** [linkedin.com/in/dev-vini-amaral](https://www.linkedin.com/in/dev-vini-amaral)
